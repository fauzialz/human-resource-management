          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full border rounded px-3 py-2 pr-9 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${fieldErrors.password ? 'border-red-500' : 'border-gray-300'}`}
              />
              <button
                type="button"
